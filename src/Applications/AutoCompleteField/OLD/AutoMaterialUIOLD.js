...
const AutoMaterialUIOLD = () => {
  ...
  useEffect(() => {
    fetch(
      `${APIurl}cities?minPopulation=1000000&namePrefix=${value}`,
      APIoptions
    )
  ...
  return (
    <div>
      <div className=" p-5 rounded-0  card text-center">
        <div className="m-auto col-4">
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField
                {...params} onChange={e=>setValue(e.target.value)}
                label="Asynchronous" value={value}
                InputProps={{
                  ...params.InputProps,
                  endAdornment: (
                    <React.Fragment>
