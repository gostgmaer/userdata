    ...
    <div className="container">
      <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <NavLink className="nav-link px-2 text-white" to='./'>Home </NavLink>
          <NavLink to='/calculator' className="nav-link px-2 text-white">Calculator</NavLink>
          <li><NavLink to='/accordian' className="nav-link px-2 text-white">Accordian</NavLink></li>
        ...
        <div className="text-end">
         ...
         <Link className="btn btn-warning" to='/registration'>Sign up</Link>
